 ...
 */
Ext.define('sunerp.view.nhanvien.TrangThaiNhanVienList', {
    extend: 'sunerp.view.core.BaseListView',
    alias: 'widget.nhanVienList',
    requires: [
        'sunerp.component.PhongBanCb'
    ],
    controller: 'sunerp.controller.nhanvien.TrangThaiNhanVienListCtr',
    inject: ['trangThaiNhanVienStore', 'userService'],
    config: {
    ...
    initComponent: function () {
        var me = this;
        me.store = this.getTrangThaiNhanVienStore();
        me.columns = [
            ...
            {header: 'Nghỉ việc', dataIndex: 'nghiViec', flex: 1},
