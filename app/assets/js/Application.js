...
Ext.define('sunerp.Application', {
    ...
    requires: [
        ...
        'sunerp.store.CongThucLuongStore',
        ...
        'sunerp.store.TrangThaiNhanVienStore',
    ...
    buildInjectorConfiguration: function () {
        ...
        config = {
            ...
            congThucLuongStore:     'sunerp.store.CongThucLuongStore',
